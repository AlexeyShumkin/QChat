...
#include <memory>
#include "../../../client/sources/regform.h"
...
QT_MOC_LITERAL(1, 8, 14), // "loginRequested"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 8), // "accepted"
QT_MOC_LITERAL(4, 33, 2), // "id"
QT_MOC_LITERAL(5, 36, 8), // "username"
QT_MOC_LITERAL(6, 45, 8), // "rejected"
QT_MOC_LITERAL(7, 54, 22), // "on_loginButton_clicked"
QT_MOC_LITERAL(8, 77, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(9, 99, 21) // "on_buttonBox_rejected"

    },
    "RegForm\0loginRequested\0\0accepted\0id\0"
    "username\0rejected\0on_loginButton_clicked\0"
...
void RegForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegForm::loginRequested)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RegForm::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegForm::accepted)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (RegForm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegForm::rejected)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void RegForm::accepted(int _t1, QString _t2)
{
